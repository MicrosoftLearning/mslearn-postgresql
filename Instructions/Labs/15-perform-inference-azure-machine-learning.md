...
In this exercise, you learned how to deploy an Azure Machine Learning model and use it to perform inference from an Azure Database for PostgreSQL flexible server using the `azure_ai` extension.
