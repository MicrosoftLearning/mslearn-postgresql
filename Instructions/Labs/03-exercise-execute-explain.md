...
lab:
  ...
  description: In this exercise, you look at the EXPLAIN function and how it can display
    the execution plan that the PostgreSQL planner generates for a supplied statement.
...
1. In the Lab file, in the section **2. Investigate EXPLAIN** highlight and run that statement.
    ...
    What sort key was used, and why?
