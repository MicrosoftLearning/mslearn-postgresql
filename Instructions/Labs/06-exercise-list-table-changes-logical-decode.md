...
lab:
  ...
  description: In this exercise, you configure logical replication, which is native
    to PostgreSQL. You create two servers, which act as publisher and subscriber.
    Data in the zoodb is replicated between them.
